...
public class MethodClass {
	// static: 인스턴스를 생성할 필요가 없음, 매개변수가 없음
	// MethodClass.noArgesMethod()로 호출
	...
	// 매개변수가 정수 1개인 메서드, MethodClass.oneArgsMethod(3);
	...
	// 매개변수가 기본형 1개, 내부에서 매개변수의 값을 수정해도 넘겨준 데이터는 변경x
	...
	public void thisMethod() {
		...
		// 인스턴스가 가진 score 호출, this가 붙으면 메서드 안에서는 찾지 않음
